...
public class Latihan9 {
    ...
    static void cetakJsonManajer() throws IOException {
        JSONArray jr = new JSONArray();
        JSONObject obj = new JSONObject();
        FileWriter file = new FileWriter("C:\\Users\\User\\IdeaProjects\\HelloWorld\\src\\main\\java\\Latihan9" +
                "\\manajer.json");
    ...
    static void lihatJsonManajer() throws IOException, ParseException {
        ...
        FileReader fr = new FileReader("C:\\Users\\User\\IdeaProjects\\HelloWorld\\src\\main\\java\\Latihan9\\manajer.json");
    ...
    static void lihatJsonStaff() throws IOException, ParseException {
        ...
        FileReader fr = new FileReader("C:\\Users\\User\\IdeaProjects\\HelloWorld\\src\\main\\java\\Latihan9\\staff" +
                ".json");
        BufferedReader bfr = new BufferedReader(fr);
        ...
        for (Object mn : arrayStaff){
            ...
            JSONArray arrayEmail = (JSONArray) objEmail;
            int i = 0;
            for (Object email : arrayEmail){
                if (i == 0){
                    System.out.print("|| Email        : "+(i+1)+". "+email + "\n");
                }else{
                    System.out.print("||              : "+(i+1)+". "+email + "\n");
                }
                i++;
            }
            i = 0;
