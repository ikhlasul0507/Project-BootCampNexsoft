...
@WebServlet("/prosesUpdateJabatan")
public class prosesUpdateJabatan extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String i = request.getParameter("idJabatan");
        setIdJabatan(i);
        ...
        try {
            md.updateDataJabatan(getIdJabatan(),getNamaJabatan(), getTunjanganMakan(), getTunjanganTransport());
