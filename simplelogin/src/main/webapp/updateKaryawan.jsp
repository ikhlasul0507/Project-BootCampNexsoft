...
String sql ="select * from tbl_karyawan where idKaryawan="+id;
...
<body>
    ...
    <div class="container">
       <form method="post" action="prosesUpdateKaryawan">
      <div class="row">
        <div class="col-25">
          <label for="nama_depan">Nama Karyawan</label>
        </div>
        <div class="col-75">
            <input type="hidden" name="idKaryawan" value="<%=resultSet.getString("idKaryawan") %>">
          <input type="text" id="nama_belakang" value="<%=resultSet.getString("namaKaryawan") %>" name="namaKaryawan"
      ...
      <div class="row">
        ...
        <div class="col-75">
          <input type="text" id="nama_belakang" value="<%=resultSet.getString("gajiKaryawan") %>" name="gajiKaryawan"
          placeholder="Gaji Karyawan.." required>
        </div>
      </div>
      <div class="row">
        <div class="col-25">
          ...
          <select id="negara">
           <option disabled selected>Lihat ID Jabatan</option>
             ...
             <div class="row">
                     ...
                     <div class="col-75">
                       <input type="text" id="nama_belakang" value="<%=resultSet.getString("idJabatan") %>" name="idJabatan" placeholder="ID Jabatan.." required>
                     </div>
                   </div>
