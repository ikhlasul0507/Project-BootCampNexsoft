...
String sql ="select * from tbl_jabatan where idJabatan="+id;
...
<body>
    ...
    <div class="container">
       <form method="post" action="prosesUpdateJabatan">
      <div class="row">
        <div class="col-25">
          <label for="nama_depan">Nama Jabatan</label>
        </div>
        <div class="col-75">
        <input type="hidden" name="idJabatan" value="<%=resultSet.getString("idJabatan") %>">
          <input type="text" id="nama_jabatan" name="namaJabatan" value="<%=resultSet.getString("namaJabatan") %>"
      ...
      <div class="row">
        ...
        <div class="col-75">
          <input type="text" id="nama_belakang" name="tunjanganMakan" value="<%=resultSet.getString("tunjanganMakan")
      ...
      <div class="row">
              ...
              <div class="col-75">
                <input type="text" id="nama_belakang" name="tunjanganTransport" value="<%=resultSet.getString
                ("tunjanganTransport")%>" placeholder="Tunjangan
                Transport.
                ."
                required>
              </div>
