...
<body>
    ...
    <div class="container">
       <form method="post" action="inputDataKaryawan">
      <div class="row">
        <div class="col-25">
          <label for="nama_depan">Nama Karyawan</label>
        </div>
        <div class="col-75">
          <input type="text" id="nama_belakang" name="namaKaryawan" placeholder="Nama Karyawan..." required>
        </div>
      </div>
      <div class="row">
        <div class="col-25">
          <label for="nama_belakang">Gaji Karyawan</label>
        </div>
        <div class="col-75">
          <input type="text" id="nama_belakang" name="gajiKaryawan" placeholder="Gaji Karyawan.." required>
        </div>
      </div>
      <div class="row">
        <div class="col-25">
          <label for="negara">Lihat Jabatan</label>
        </div>
        <div class="col-75">
          <select id="negara">
           <option disabled selected>Lihat ID Jabatan</option>
             	<%@page import="java.sql.*" %>
                  ...
                  %>
                   ...
                   {
                   %>
                   <option value=""><%=rs.getString(2)%> - ID = <%=rs.getString(1)%></option>
                  <%
                   }
                   %>
                   <%
             ...
             <div class="row">
                     <div class="col-25">
                       <label for="nama_belakang">Masukan ID Jabatan</label>
                     </div>
                     <div class="col-75">
                       <input type="text" id="nama_belakang" name="idJabatan" placeholder="ID Jabatan.." required>
                     </div>
                   </div>
    ...
    <h4>HASIL INPUT DATA JABATAN</h4>
        		<%@page import="java.sql.*" %>
                    ...
                    //membuat query
                     String query = "SELECT a.idKaryawan, a.namaKaryawan, a.gajiKaryawan, b.namaJabatan FROM" +
                                                         " tbl_karyawan a INNER JOIN tbl_jabatan b ON a.idJabatan = b.idJabatan";
                    ...
                    %>
                     ...
                     <td>
                        <a href="updateKaryawan.jsp?id=<%=rs.getString(1)%>" class="btnEdit">Edit</a>
                        <a href="deleteKaryawan.jsp?id=<%=rs.getString(1)%>" onClick="return confirm('Yakin Keluar ?')" class="btnHapus">Hapus</a>
                     </td>
                     </tr>
